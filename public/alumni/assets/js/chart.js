$(function () {
  ...
  'use strict';
  var data = {
    labels: ["2000-2005", "2006-2011", "2012-2017", "2018-2023", "2024-2029", "2030-2035"],
    datasets: [{
      label: '# Alumni',
      data: [10, 19, 3, 25, 2, 3],
      backgroundColor: [
...
//START PIE
  ...
  if ($("#polarArea").length) {
    var polarAreaCanvas = $("#polarArea").get(0).getContext("2d");
    var polarArea = new Chart(polarAreaCanvas, {
      type: 'polarArea',
      data: polarAreaData,
