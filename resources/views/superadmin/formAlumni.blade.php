          ...
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                ...
                <form class="user" method="post" action="/insertalumni/superadmin" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="">
                    <div class="input-group">
                      ...
                      <input class="input--style-4" type="number" name="phone" maxlength="12" required>
                    </div>
                  </div> <br> <br>
