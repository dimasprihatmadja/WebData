      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <h1 class="title">Edit Akun</h1> <br> <br>
                <form method="post" action="/updateakun">
                  @csrf
                  ...
                  <div class="row row-space">
                    <div class="col-2">
                      <div class="input-group ">
                        ...
                        <input class="input--style-4" type="text" name="username" value="{{$data->username}}" required>
                      </div>
                    </div>
                    <div class="col-2">
                      <div class="input-group">
                  ...
                  <div class="p-t-15">
                    ...
                    <a href="/kelola_akun"><button type="button" class="btn btn--radius-2 btn-danger">Cancel</button></a>
