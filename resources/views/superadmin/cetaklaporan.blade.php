                        ...
                        <dir class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="/cetakpdf" class="btn btn-sm btn-primary ml-auto" style="background-color: #047edf; border: 0px; padding :1em">Cetak laporan .PDF</a>
                                    <a href="/cetakxlsx" class="btn btn-sm btn-primary ml-auto" style="background-color: #047edf; border: 0px; padding :1em">Cetak laporan .XLSX</a>
                                </div>
                            </div>
                        </dir>
                    </div>
